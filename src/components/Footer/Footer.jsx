					...
					<div className='flex'>
						<div>
							<button
								...
								className='w-6 h-6 mr-2 border-2 border-accent-focus text-gray-900 font-semibold bg-gray-100 rounded-sm'>
								A
							</button>
							...
							<button
								...
								className='w-6 h-6 mr-2 border-2 border-accent-focus text-gray-100 font-semibold bg-black rounded-sm'>
								A
							</button>
						</div>
					</div>
					...
					<div className='grid grid-flow-col gap-4'>
						<a>
							<svg
								...
								height='24'
								viewBox='0 0 24 24'
								className='fill-current text-accent hover:text-blue-500 transition duration-200'>
