...
function MediaEditor({
  ...
  /**
   * Function to save user media data 
   */
  ...
  /**
   * Handle event to get a number of stars user rates a media
   * @param {*} rating number of stars from 0 to 5
  ...
  /**
   * Function to get the value from a media status select option
   * @param {*} defaultValue actual selected media status
   */
