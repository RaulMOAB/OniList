...
export default function TrendingManga() {
  ...
  const getManhwaManga = async () => {
      const response = await fetch(process.env.NEXT_PUBLIC_API_ENDPOINT+`manga/manhwa?page=${pageNumber}`);
      return response.json();   
  };
