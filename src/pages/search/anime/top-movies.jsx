...
export default function TopMovies() {
  ...
  const getMovieAnime = async () => {
      const response = await fetch(process.env.NEXT_PUBLIC_API_ENDPOINT+`anime/movie?page=${pageNumber}`);
      return response.json();   
  };
    ...
    getMovieAnime()
      .then((res) => {
        ...
        medias.forEach((media,index) => {
            setMovieAnime(movieAnime => [...movieAnime, media])
        })
    ...
    <>
      ...
      <Container>
        <main className="pb-10 2xl:px-28 xl:px-16  lg:px-2 sm:px-4 px-4">
            <h1 className="text-accent font-semibold ml-3 text-2xl mt-10">Top Anime Movies</h1>
          <section id="filters">
          ...
          <div>
            {showFiltered ? (
              <div>
                ...
                {/* <ListPreviewTop data={movieAnime} /> */}
