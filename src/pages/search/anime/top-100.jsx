...
import ListPreviewTop from "./../../../components/Card/ListPreviewTop";
...
const getTopAnime = async () => {
    const response = await fetch(process.env.NEXT_PUBLIC_API_ENDPOINT+'anime/top');
        ...
        <>
            ...
            <Container>
                    <main className="pb-10 2xl:px-28 xl:px-16  lg:px-2 sm:px-4 px-4">
                        <h1 className="text-accent font-semibold ml-3 text-2xl mt-10">TOP 100 Anime</h1>
                    <section id="filters">
